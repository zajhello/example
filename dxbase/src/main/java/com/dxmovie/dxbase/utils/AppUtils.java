...
public final class AppUtils {
    ...
    public static void installApp(final File file) {
        ...
        AppManager.getTopActivityOrApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        AppManager.getTopActivityOrApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String pkgName) {
        PackageManager packageManager = AppManager.getTopActivityOrApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        ...
        try {
            PackageManager pm = AppManager.getTopActivityOrApp().getPackageManager();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static boolean isAppRunning(@NonNull final String pkgName) {
        ...
        ActivityManager am = (ActivityManager) AppManager.getTopActivityOrApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am != null) {
    ...
    public static void launchApp(final String packageName) {
        ...
        AppManager.getTopActivityOrApp().startActivity(launchAppIntent);
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        Intent intent = getLaunchAppIntent(AppManager.getTopActivityOrApp().getPackageName(), true);
        if (intent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        AppManager.getTopActivityOrApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return AppManager.getTopActivityOrApp().getPackageName();
    }
    ...
    public static String getAppName() {
        try {
            return getAppName(AppManager.getsApplication().getPackageName());
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    public static String getAppName(final String packageName) {
        if (isSpace(packageName)) return "";
        try {
            PackageManager pm = AppManager.getsApplication().getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppPath() {
        return getAppPath(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(AppManager.getTopActivityOrApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            ApplicationInfo ai = AppManager.getTopActivityOrApp().getPackageManager().getApplicationInfo(pkgName, 0);
            if (ai != null) {
                return ai.uid;
            }
        } catch (Exception e) {
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(AppManager.getTopActivityOrApp(), authority, file);
            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        }
        AppManager.getTopActivityOrApp().grantUriPermission(AppManager.getTopActivityOrApp().getPackageName(), data, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) AppManager.getTopActivityOrApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AppManager.getTopActivityOrApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AppManager.getTopActivityOrApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AppManager.getTopActivityOrApp()
     ...
     * 创建加密sign
     */
    public static String createSign(String time) {
        String signUrl = "";
        TreeMap<String, String> treeMap = new TreeMap<>();
        treeMap.put("device-id", DeviceUtils.getUniqueID());
        treeMap.put("os-type", "2");
        ...
        String s = signUrl.substring(0, signUrl.length() - 1);
        String sign = s + "global";
