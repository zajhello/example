...
public class ViewAdapter {
    ...
    public static void onScrollChangeCommand(final RecyclerView recyclerView,
                                             final BindingCommandWithParams<ScrollDataWrapper> onScrollChangeCommand,
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (onScrollChangeCommand != null) {
                    onScrollChangeCommand.executeAction(new ScrollDataWrapper(dx, dy, state));
                }
            }
    ...
    public static void onLoadMoreCommand(final RecyclerView recyclerView, final BindingCommandWithParams<Integer> onLoadMoreCommand) {
    ...
    public static class OnScrollListener extends RecyclerView.OnScrollListener {
        ...
        public OnScrollListener(final BindingCommandWithParams<Integer> onLoadMoreCommand) {
