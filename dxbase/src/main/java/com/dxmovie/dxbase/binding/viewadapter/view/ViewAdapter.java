...
public class ViewAdapter {
    ...
    public static void replyCurrentView(View currentView, BindingCommandWithParams<View> bindingCommand) {
    ...
    public static void onFocusChangeCommand(View view, final BindingCommandWithParams<Boolean> onFocusChangeCommand) {
        view.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (onFocusChangeCommand != null) {
                    onFocusChangeCommand.executeAction(hasFocus);
                }
            }
        });
    }
