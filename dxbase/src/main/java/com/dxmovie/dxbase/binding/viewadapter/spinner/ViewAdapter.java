package com.dxmovie.dxbase.binding.viewadapter.spinner;
...
public class ViewAdapter {
    ...
    public static void onItemSelectedCommand(final Spinner spinner, final List<IKeyAndValue> itemDatas, String valueReply, int resource, int dropDownResource, final BindingCommandWithParams<IKeyAndValue> bindingCommand) {
        if (itemDatas == null) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                bindingCommand.executeAction(iKeyAndValue);
            }
